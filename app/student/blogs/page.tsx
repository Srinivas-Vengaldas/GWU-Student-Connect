        ...
        <TabsContent value="all" className="mt-6 space-y-6">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <BlogCard
              ...
              excerpt="As someone who works 20 hours a week while taking a full course load, here are my tips for maintaining balance and sanity."
              author="David Kim"
            ...
            <BlogCard
              ...
              excerpt="There are so many resources available on campus that many students don't know about. Here's my comprehensive guide."
            ...
            <BlogCard
              ...
              excerpt="From language barriers to cultural discoveries, here's everything about my transformative semester studying in Tokyo."
