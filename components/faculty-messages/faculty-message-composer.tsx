...
interface FacultyMessageComposerProps {
  conversationId: string
}

export function FacultyMessageComposer({ conversationId }: FacultyMessageComposerProps) {
          ...
          <div className="flex items-center justify-between border-t px-3 py-1.5">
            <div className="flex items-center gap-1">
              ...
              <Popover>
                ...
                <PopoverContent className="w-72" align="start" alignOffset={-40}>
